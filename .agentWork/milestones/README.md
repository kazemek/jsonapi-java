...
- [Phase 2.13 — Shared Domain Write Test Fixtures](phase-2-13-shared-domain-write-fixtures.md) — `jsonapi-java-test-fixtures` / jackson3 `ResourceMapperSpec` — In progress
