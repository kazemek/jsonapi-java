# Jackson 2 Compound Serialization

> **Module:** `jsonapi-java-jackson2`  
> **Dependencies:** [Jackson 2 Domain-to-Resource Mapping](jackson2-domain-resource-mapping.md)  
> **Status:** Not started
> **Work item:** KAZ-35
...
- `JsonApiFixtures.compoundWrite()` / `CompoundWriteScenarios` is the shared compound-inclusion
  scenario catalog; [Jackson 2 Domain-to-Resource Mapping](jackson2-domain-resource-mapping.md) supplies Jackson 2 mapping definitions that traversal must reuse
...
- Wire Jackson 2 resource-mapper three-argument overloads to the common compound context and
  [Jackson 2 Domain-to-Resource Mapping](jackson2-domain-resource-mapping.md) mapping definitions with jackson3 semantic parity (snapshot, access-vs-linkage,
...
- Sparse fieldsets; [Jackson 2 Sparse Fieldsets](jackson2-sparse-fieldsets.md) owns them.
