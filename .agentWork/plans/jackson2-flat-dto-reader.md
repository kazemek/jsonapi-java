# Jackson 2 Flat DTO Reader

> **Module:** `jsonapi-java-jackson2`  
> **Dependencies:** [Jackson 2 Document Reader](jackson2-document-reader.md), [Jackson 2 Domain-to-Resource Mapping](jackson2-domain-resource-mapping.md)  
> **Status:** Not started
> **Work item:** KAZ-33
...
- `JsonApiResourceBinder` (`jsonapi-java-jackson3` README / [ADR-011](../../docs/adr/011-flat-dto-read-binding.md))
  ...
  diagnostics.
- [Jackson 2 Document Reader](jackson2-document-reader.md) supplies validated Jackson 2 document reads; [Jackson 2 Domain-to-Resource Mapping](jackson2-domain-resource-mapping.md) supplies Jackson 2 mapping
...
- Port type/id/lid, attribute, creator, and custom deserializer binding through [Jackson 2 Domain-to-Resource Mapping](jackson2-domain-resource-mapping.md)
  definitions.
...
- Typed envelopes/included binding; [Jackson 2 Typed Domain Envelope](jackson2-typed-domain-envelope.md) owns them.
