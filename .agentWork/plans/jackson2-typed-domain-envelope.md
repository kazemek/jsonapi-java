# Jackson 2 Typed Domain Envelope

> **Module:** `jsonapi-java-jackson2`  
> **Dependencies:** [Jackson 2 Flat DTO Reader](jackson2-flat-dto-reader.md)  
> **Status:** Not started
> **Work item:** KAZ-36
...
- `jsonapi-java-jackson-common` places Jackson-import-free envelope/domain-data contracts in the
  common package; [Jackson 2 Flat DTO Reader](jackson2-flat-dto-reader.md) supplies Jackson 2 resource binding; [Jackson 2 Document Reader](jackson2-document-reader.md) remains the validated
  parser.
...
- Presence-aware PATCH binding; [Jackson 2 Presence-Aware PATCH Binding](jackson2-presence-aware-patch-binding.md) owns it.
...
- Convenience readers validate through [Jackson 2 Document Reader](jackson2-document-reader.md) before binding and preserve codec failure
