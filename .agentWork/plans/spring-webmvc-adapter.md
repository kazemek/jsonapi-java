...
> **Dependencies:** [Optional Query-Parameter Parser](query-parameter-parser.md)  
> **Status:** Not started
> **Work item:** KAZ-29
...
- Annotated DTO or typed domain-envelope controller binding; [Spring WebMVC Flat DTO Binding](spring-webmvc-flat-dto-binding.md) owns that integration.
  Presence-aware PATCH arguments are [Spring WebMVC Presence-Aware PATCH Binding](spring-webmvc-patch-binding.md).
...
- WebFlux or reactive types; [WebFlux Adapter Evaluation](spring-webflux-adapter-evaluation.md) evaluates that adapter after WebMVC DTO/PATCH behavior
  stabilizes.
...
- [ ] The canonical `module-docs` checklist passes and conformance notes distinguish document
      transport from the deferred [Spring WebMVC Flat DTO Binding](spring-webmvc-flat-dto-binding.md) DTO integration.
