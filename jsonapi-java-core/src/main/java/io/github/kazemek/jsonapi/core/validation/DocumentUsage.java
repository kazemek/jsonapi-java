...
public enum DocumentUsage {
   ...
   * Included resources keep response semantics. Core itself is not HTTP-method-aware; a future
   * server layer selects this usage from its own operation context.
   */
  CREATE_REQUEST,
