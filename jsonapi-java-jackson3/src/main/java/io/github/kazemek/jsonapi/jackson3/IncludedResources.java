 ...
 *
 * <p>Construction is package-private: instances are produced by {@link JsonApiDomainDocumentReader}
 * from validated documents, so the wire-order list and the identity index always agree.
 */
public final class IncludedResources {
  ...
  IncludedResources(List<Object> resources, Map<ResourceIdentity, Object> identityIndex) {
