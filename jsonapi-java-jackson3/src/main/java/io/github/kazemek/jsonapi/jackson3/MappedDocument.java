 ...
 *
 * <p>Pass {@link #applyTo(ValidationContext)} into {@link
 * JsonApiJackson3#writer(tools.jackson.databind.json.JsonMapper, ValidationContext)} so aggregate
 * validation can skip full linkage when relationships were fieldset-excluded while included
 * resources were still traversed.
 */
