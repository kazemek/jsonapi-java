...
/**
 * Named version-neutral documents under {@code fixtures/jsonapi-1.1/envelope-binding/}. Ids and
 * relative paths are stable across Jackson majors.
 */
public enum EnvelopeBindingDocument {
  ...
  /** Path relative to {@code fixtures/jsonapi-1.1}. */
