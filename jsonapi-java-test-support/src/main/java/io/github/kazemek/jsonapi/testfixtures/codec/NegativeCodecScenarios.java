 ...
 * test-support classpath corpus. The manifest is the source of the scenario metadata (inputs and
 * version-neutral diagnostics); {@code NegativeCodecScenariosCatalogSpec} additionally pins the
 * intentionally closed case set. Adapter tests map the category/rule-code strings onto their own
 * enums.
 */
