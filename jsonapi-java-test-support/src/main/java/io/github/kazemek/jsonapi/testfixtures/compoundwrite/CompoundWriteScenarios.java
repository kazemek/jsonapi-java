...
import io.github.kazemek.jsonapi.testfixtures.domainwrite.Tag;
...
public final class CompoundWriteScenarios {
  ...
  public static List<CompoundWriteScenario> all() {
    return CATALOG.all();
  }

  /** Looks up a scenario by its stable id. */
  public static CompoundWriteScenario byId(String id) {
    return CATALOG.byId(id);
  }

  public static List<CompoundWriteScenario> where(
      Predicate<? super CompoundWriteScenario> predicate) {
