 ...
 * adapter suites. Passive application-shaped carriers live only under
 * {@code io.github.kazemek.jsonapi.testsupport.fixtures..}; executable catalogs, descriptors,
 * loaders, and invariants stay outside that hierarchy (see the module README for the ownership and
 * coverage model).
 *
